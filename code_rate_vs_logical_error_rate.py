...
def PlotCodeRateVsErrRate(init_state_mode, num_trials_tot, code_name_list, noise_model_kraus):
    ...
    for code_name in code_name_list:
        ...
        logical_err_rate_vec.append(logical_vs_physical_error_rates.GiveLogicalErrRate(
    ...
    plt.title(
        'Logical Error Rates vs code rate various codes with depolarizing noise (0.4)')
...
PlotCodeRateVsErrRate(init_state_mode, num_trials_tot,
                      code_name_list, noise_model_kraus)
